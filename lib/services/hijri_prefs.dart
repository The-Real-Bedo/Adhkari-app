...
///
/// القيمة منشورة في [offsetNotifier] عشان أي شاشة معروضة تتحدّث لحظياً
/// لما المستخدم يغيّر الإزاحة من الإعدادات، من غير ما نمرّر callbacks
/// بين الشاشات ولا نستنى الشاشة تتبني من الأول.
class HijriPrefs {
